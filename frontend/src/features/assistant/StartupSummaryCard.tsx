  ...
  return (
    <Card className="p-5" data-testid="ai-summary">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="font-semibold text-stone-900 dark:text-stone-100">Yönetici özeti</h2>
      ...
      {summary.data ? (
        <div className="mt-4 flex flex-col gap-4">
          <p
            className="text-sm leading-relaxed text-stone-700 dark:text-stone-200"
          ...
          <div>
            <p className="text-xs font-medium tracking-wide text-stone-500 uppercase">Dayanak</p>
            <ul className="mt-1.5 flex flex-col gap-1 text-sm text-stone-600 dark:text-stone-300">
