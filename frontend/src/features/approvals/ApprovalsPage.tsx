            ...
            <Card className="px-5 py-4 transition-colors hover:border-brand-400">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                ...
                <div className="text-right text-sm">
                  <p className="text-slate-700 dark:text-slate-200">{item.submittedByName}</p>
                  <p className="text-slate-500">{formatDate(item.submittedAt)}</p>
                </div>
              ...
              {item.reviewNote ? (
                <p className="mt-3 border-l-2 border-slate-300 pl-3 text-sm text-slate-600 dark:border-slate-700 dark:text-slate-300">
                  {item.reviewNote}
                </p>
              ) : null}
            </Card>
